package com.example.debezium.demo.listener;

import com.example.debezium.demo.service.CustomerService;
    ...
    private void handleChangeEvent(RecordChangeEvent<SourceRecord> sourceRecordRecordChangeEvent) {
        ...
        if (sourceRecordChangeValue != null) {
		    ...
		    Struct structSource = (Struct) sourceRecordChangeValue.get("source");
		 	System.out.println(" table ="+structSource.get("table")+" " );
		    String tableName=structSource.get("table").toString();
